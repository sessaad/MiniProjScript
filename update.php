...
<head>
    ...
    <head>
        ...
        <form method="post">
            ...
            <div class="row mb-3">
                <label class="col-form-label col-sm-1" for="fname">Last Name:</label>
                <div class="col-sm-6">
                    <input value="<?php echo $lnameValue ?>" class="form-control" type="text" id="fname" name="firstName">
                </div>
            </div>
            <div class="row mb-3">
                <label class="col-form-label col-sm-1" for="fname">Email:</label>
                <div class="col-sm-6">
                    <input value="<?php echo $emailValue ?>" class="form-control" type="text" id="fname" name="firstName">
                </div>
            </div>
